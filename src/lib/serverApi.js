...
class ServerlistSpaceClient {
  ...
  getServer(id) {
    ...
    return new Promise((resolve, reject) => {
      nodefetch(`${this.url}/servers/${id}`, {headers: { "Content-Type": "application/json", "Authorization": this._auth, "User-Agent": "botlist.space-api (https://www.npmjs.com/package/botlist.space-api)" }})
        .then(res => res.json())
  ...
  getALLServers(pageNumb) {
    ...
    return new Promise((resolve, reject) => {
      nodefetch(`${this.url}/servers/`, {headers: { "Content-Type": "application/json", "Authorization": this._auth, page: pageNumb, "User-Agent": "botlist.space-api (https://www.npmjs.com/package/botlist.space-api)" }})
        .then(res => res.json())
        .then(json => resolve(json))
        .catch(err => reject(err));
    });
  ...
  getStats() {
    ...
    return new Promise((resolve, reject) => {
      nodefetch(`${this.url}/statistics`, {headers: { "Content-Type": "application/json", "Authorization": this._auth, "User-Agent": "botlist.space-api (https://www.npmjs.com/package/botlist.space-api)" }})
        .then(res => res.json())
        .then(json => resolve(json))
        .catch(err => reject(err));
    });
  ...
  getUser(id) {
    ...
    return new Promise((resolve, reject) => {
      nodefetch(`${this.url}/users/${id}`, {headers: { "Content-Type": "application/json", "Authorization": this._auth, "User-Agent": "botlist.space-api (https://www.npmjs.com/package/botlist.space-api)" }})
        .then(res => res.json())
        .then(json => resolve(json))
        .catch(err => reject(err));
    });
  ...
  getUserServers(id, pageNumb) {
    ...
    return new Promise((resolve, reject) => {
      nodefetch(`${this.url}/users/${id}/servers`, {headers: { "Content-Type": "application/json", "Authorization": this._auth, page: pageNumb, "User-Agent": "botlist.space-api (https://www.npmjs.com/package/botlist.space-api)" }})
        .then(res => res.json())
        .then(json => resolve(json))
        .catch(err => reject(err));
    });
